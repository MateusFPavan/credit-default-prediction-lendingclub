...
para quem concede crédito, essas duas coisas não são a mesma coisa.
...
em juros que deixou de ganhar.** O resultado é um ganho líquido de US$ 9,0 mi sobre a
política de aprovar todo mundo. Esse ganho é estatisticamente robusto (IC 95% de
US$ 7,6 mi a US$ 10,7 mi) e se sustenta também contra um baseline de regressão logística
(+US$ 6,3 mi).
...
Acertar esse corte, e acertar em solicitantes genuinamente novos e não nos dados que o
...
- **Ganho líquido de +US$ 9,0 mi** sobre aprovar todo mundo. Essa combinação foi
  escolhida por lucro esperado, não por acurácia, e essa escolha importou: o modelo
  vencedor empata com um baseline mais simples de regressão logística em AUC (0,68), mas
